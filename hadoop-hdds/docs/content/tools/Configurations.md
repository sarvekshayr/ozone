...
|:----------------|:----------------------------|
| **Value**       | org.apache.hadoop.fs.ozone.OzoneTrashPolicy |
| **Tag**         | `OZONE`<br/>`OZONEFS`<br/>`CLIENT` |
...
|:----------------|:----------------------------|
| **Value**       | 60000 |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`S3GATEWAY` |
...
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`SECURITY`<br/>`TOKEN` |
...
|:----------------|:----------------------------|
| **Value**       | 30s |
| **Tag**         | `OZONE`<br/>`DATANODE`<br/>`MANAGEMENT` |
...
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`MANAGEMENT` |
...
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`DEBUG`<br/>`CONTAINER` |
...
|:----------------|:----------------------------|
| **Value**       | 9857 |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`PIPELINE`<br/>`RATIS`<br/>`MANAGEMENT` |
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`STORAGE`<br/>`MANAGEMENT`<br/>`RATIS` |
...
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`RATIS`<br/>`DATASTREAM` |
...
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`MANAGEMENT`<br/>`PIPELINE`<br/>`RATIS` |
...
|:----------------|:----------------------------|
| **Value**       | 9858 |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`PIPELINE`<br/>`RATIS` |
...
|:----------------|:----------------------------|
| **Value**       | 1GB |
| **Tag**         | `OZONE`<br/>`RATIS`<br/>`PERFORMANCE` |
...
|:----------------|:----------------------------|
| **Value**       | 32MB |
| **Tag**         | `OZONE`<br/>`DEBUG`<br/>`CONTAINER`<br/>`RATIS` |
...
|:----------------|:----------------------------|
| **Value**       | GRPC |
| **Tag**         | `OZONE`<br/>`RATIS`<br/>`MANAGEMENT` |
...
|:----------------|:----------------------------|
| **Value**       | 100000 |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`RATIS` |
...
| **Name**        | `hdds.container.ratis.statemachine.write.wait.interval` |
|:----------------|:----------------------------|
| **Value**       | 10m |
| **Tag**         | `OZONE`<br/>`DATANODE` |
| **Description** | Timeout for the write path for container blocks. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`MANAGEMENT` |
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`STORAGE`<br/>`MANAGEMENT` |
...
| **Name**        | `hdds.datanode.db.config.path` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`STORAGE` |
| **Description** | Path to an ini configuration file for RocksDB on datanode component. |
--------------------------------------------------------------------------------
...
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`STORAGE`<br/>`MANAGEMENT` |
| **Description** | Determines where on the local filesystem HDDS data will be stored. The directories should be tagged with corresponding storage types ([SSD]/[DISK]/[ARCHIVE]/[RAM_DISK]) for storage policies. The default storage type will be DISK if the directory does not have a storage type tagged explicitly. |
--------------------------------------------------------------------------------
...
| **Name**        | `hdds.datanode.disk.balancer.enabled` |
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`DATANODE`<br/>`DISKBALANCER` |
| **Description** | If this property is set to true, then the Disk Balancer feature is enabled on Datanodes, and users can use this service. By default, this is disabled. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.datanode.dns.interface` |
|:----------------|:----------------------------|
| **Value**       | default |
| **Tag**         | `OZONE`<br/>`DATANODE` |
| **Description** | The name of the Network Interface from which a Datanode should report its IP address. e.g. eth2. This setting may be required for some multi-homed nodes where the Datanodes are assigned multiple hostnames and it is desirable for the Datanodes to use a non-default hostname. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.datanode.dns.nameserver` |
|:----------------|:----------------------------|
| **Value**       | default |
| **Tag**         | `OZONE`<br/>`DATANODE` |
| **Description** | The host name or IP address of the name server (DNS) which a Datanode should use to determine its own host name. |
--------------------------------------------------------------------------------
...
| **Name**        | `hdds.datanode.hostname` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`DATANODE` |
| **Description** | Optional. The hostname for the Datanode containing this configuration file. Will be different for each machine. Defaults to current hostname. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.datanode.http-address` |
|:----------------|:----------------------------|
| **Value**       | 0.0.0.0:9882 |
| **Tag**         | `HDDS`<br/>`MANAGEMENT` |
...
| **Tag**         | `HDDS`<br/>`SECURITY`<br/>`MANAGEMENT`<br/>`KERBEROS` |
...
|:----------------|:----------------------------|
| **Value**       | simple |
| **Tag**         | `DATANODE`<br/>`SECURITY`<br/>`KERBEROS` |
...
|:----------------|:----------------------------|
| **Value**       | 0.0.0.0:9883 |
| **Tag**         | `HDDS`<br/>`MANAGEMENT`<br/>`SECURITY` |
...
| **Name**        | `hdds.datanode.kerberos.keytab.file` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`DATANODE` |
| **Description** | The keytab file used by each Datanode daemon to login as its service principal. The principal name is configured with `hdds.datanode.kerberos.principal`. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.datanode.kerberos.principal` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`DATANODE` |
| **Description** | The Datanode service principal. This is typically set to dn/_HOST@REALM.TLD. Each Datanode will substitute _HOST with its own fully qualified hostname at startup. The _HOST placeholder allows using the same configuration setting on all Datanodes. |
--------------------------------------------------------------------------------
...
| **Name**        | `hdds.datanode.read.threadpool` |
|:----------------|:----------------------------|
| **Value**       | 10 |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`PERFORMANCE` |
| **Description** | The number of threads in RPC server reading from the socket for Datanode client service endpoints. This config overrides Hadoop configuration "ipc.server.read.threadpool.size" for HddsDatanodeClientProtocolServer. The default value is 10. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 500ms |
| **Tag**         | `OZONE`<br/>`DATANODE`<br/>`PERFORMANCE` |
...
|:----------------|:----------------------------|
| **Value**       | 0.95 |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`MANAGEMENT` |
...
| **Name**        | `hdds.datanode.use.datanode.hostname` |
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`DATANODE` |
...
|:----------------|:----------------------------|
| **Value**       | org.apache.hadoop.ozone.container.common.volume.CapacityVolumeChoosingPolicy |
| **Tag**         | `OZONE`<br/>`CONTAINER`<br/>`STORAGE`<br/>`MANAGEMENT` |
| **Description** | The class name of the policy for choosing volumes in the list of directories. Defaults to org.apache.hadoop.ozone.container.common.volume.CapacityVolumeChoosingPolicy. This volume choosing policy randomly chooses two volumes with remaining space and then picks the one with lower utilization. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.db.profile` |
|:----------------|:----------------------------|
| **Value**       | DISK |
| **Tag**         | `OZONE`<br/>`OM`<br/>`PERFORMANCE` |
...
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`SECURITY`<br/>`TLS` |
...
|:----------------|:----------------------------|
| **Value**       | OPENSSL |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`SECURITY`<br/>`TLS`<br/>`CRYPTO_COMPLIANCE` |
| **Description** | HDDS GRPC server TLS provider. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.heartbeat.initial-interval` |
|:----------------|:----------------------------|
| **Value**       | 2s |
| **Tag**         | `OZONE`<br/>`MANAGEMENT` |
| **Description** | Heartbeat interval used during Datanode initialization for SCM. |
--------------------------------------------------------------------------------
...
| **Name**        | `hdds.heartbeat.recon.initial-interval` |
|:----------------|:----------------------------|
| **Value**       | 60s |
| **Tag**         | `OZONE`<br/>`MANAGEMENT`<br/>`RECON` |
| **Description** | Heartbeat interval used during Datanode initialization for Recon. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.heartbeat.recon.interval` |
|:----------------|:----------------------------|
| **Value**       | 60s |
| **Tag**         | `OZONE`<br/>`MANAGEMENT`<br/>`RECON` |
...
|:----------------|:----------------------------|
| **Value**       | RSA |
| **Tag**         | `SCM`<br/>`HDDS`<br/>`X509`<br/>`SECURITY`<br/>`CRYPTO_COMPLIANCE` |
...
|:----------------|:----------------------------|
| **Value**       | keys |
| **Tag**         | `SCM`<br/>`HDDS`<br/>`X509`<br/>`SECURITY` |
...
|:----------------|:----------------------------|
| **Value**       | 60000ms |
| **Tag**         | `OZONE`<br/>`PIPELINE`<br/>`MANAGEMENT` |
...
| **Name**        | `hdds.raft.server.rpc.first-election.timeout` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`RATIS`<br/>`MANAGEMENT` |
| **Description** | ratis Minimum timeout for the first election of a leader. If not configured, fallback to `hdds.ratis.leader.election.minimum.timeout.duration`. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | /etc/security/keytabs/HTTP.keytab |
| **Tag**         | `SCM`<br/>`SECURITY`<br/>`KERBEROS` |
...
|:----------------|:----------------------------|
| **Value**       | simple |
| **Tag**         | `OM`<br/>`SECURITY`<br/>`KERBEROS` |
| **Description** | simple or kerberos. If kerberos is set, SPNEGO will be used for http authentication. |
--------------------------------------------------------------------------------
...
| **Name**        | `hdds.scm.safemode.log.interval` |
|:----------------|:----------------------------|
| **Value**       | 1m |
| **Tag**         | `HDDS`<br/>`SCM`<br/>`OPERATION` |
| **Description** | Interval at which SCM logs safemode status while SCM is in safemode. Default is 1 minute. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | HmacSHA256 |
| **Tag**         | `SCM`<br/>`SECURITY`<br/>`CRYPTO_COMPLIANCE` |
...
| **Name**        | `hdds.security.client.datanode.disk.balancer.protocol.acl` |
|:----------------|:----------------------------|
| **Value**       | * |
| **Tag**         | `SECURITY` |
| **Description** | Comma separated list of users and groups allowed to access disk balancer protocol. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | BC |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`X509`<br/>`SECURITY`<br/>`CRYPTO_COMPLIANCE` |
...
|:----------------|:----------------------------|
| **Value**       | SHA256withRSA |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`SECURITY`<br/>`CRYPTO_COMPLIANCE` |
| **Description** | X509 signature certificate. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.xframe.enabled` |
|:----------------|:----------------------------|
| **Value**       | true |
| **Tag**         | `OZONE`<br/>`HDDS` |
| **Description** | If true, then enables protection against clickjacking by returning X_FRAME_OPTIONS header value set to SAMEORIGIN. Clickjacking protection prevents an attacker from using transparent or opaque layers to trick a user into clicking on a button or link on another page. |
--------------------------------------------------------------------------------

| **Name**        | `hdds.xframe.value` |
|:----------------|:----------------------------|
| **Value**       | SAMEORIGIN |
| **Tag**         | `OZONE`<br/>`HDDS` |
| **Description** | This configration value allows user to specify the value for the X-FRAME-OPTIONS. The possible values for this field are DENY, SAMEORIGIN and ALLOW-FROM. Any other value will throw an exception when Datanodes are starting up. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | true |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`CLIENT` |
...
|:----------------|:----------------------------|
| **Value**       | 1m |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`SCM` |
...
|:----------------|:----------------------------|
| **Value**       | 1MB |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`CONTAINER`<br/>`PERFORMANCE` |
...
| **Name**        | `ozone.chunk.read.mapped.buffer.max.count` |
|:----------------|:----------------------------|
| **Value**       | 0 |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`CONTAINER`<br/>`PERFORMANCE` |
| **Description** | The default max count of memory mapped buffers allowed for a DN. Default 0 means no mapped buffers allowed for data read. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 30s |
| **Tag**         | `OZONE`<br/>`CLIENT`<br/>`MANAGEMENT` |
| **Description** | Timeout for ozone ec grpc client during write. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.client.elastic.byte.buffer.pool.max.size` |
|:----------------|:----------------------------|
| **Value**       | 16GB |
| **Tag**         | `OZONE`<br/>`CLIENT` |
| **Description** | The maximum total size of buffers that can be cached in the client-side ByteBufferPool. This pool is used heavily during EC read and write operations. Setting a limit prevents unbounded memory growth in long-lived rpc clients like the S3 Gateway. Once this limit is reached, used buffers are not put back to the pool and will be garbage collected. |
--------------------------------------------------------------------------------
...
| **Value**       | 500 |
| **Tag**         |  |
| **Description** | Expert only. Ozone RpcClient attempts talking to each OzoneManager ipc.client.connect.max.retries (default = 10) number of times before failing over to another OzoneManager, if available. This parameter represents the number of times per request the client will failover before giving up. This value is kept high so that client does not give up trying to connect to OMs easily. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.client.follower.read.enabled` |
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         |  |
| **Description** | Enable client to read from OM followers. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 10d |
| **Tag**         | `OZONE`<br/>`CLIENT`<br/>`SECURITY` |
...
| **Name**        | `ozone.client.server-defaults.validity.period.ms` |
|:----------------|:----------------------------|
| **Value**       | 3600000 |
| **Tag**         | `OZONE`<br/>`CLIENT`<br/>`SECURITY` |
| **Description** | The amount of milliseconds after which cached server defaults are updated. By default this parameter is set to 1 hour. Support multiple time unit suffix(case insensitive). If no time unit is specified then milliseconds is assumed. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 1024 |
| **Tag**         | `PERFORMANCE`<br/>`CONTAINER`<br/>`STORAGE` |
...
|:----------------|:----------------------------|
| **Value**       | 1m |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`OM` |
...
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`CLIENT`<br/>`OM` |
| **Description** | Enable hsync/hflush on the Ozone Manager and/or client side. Disabled by default. Can be enabled only when `ozone.hbase.enhancements.allowed` = true |
--------------------------------------------------------------------------------

| **Name**        | `ozone.fs.iterate.batch-size` |
|:----------------|:----------------------------|
| **Value**       | 100 |
| **Tag**         | `OZONE`<br/>`OZONEFS` |
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`SECURITY`<br/>`KERBEROS` |
...
|:----------------|:----------------------------|
| **Value**       | HTTP_ONLY |
| **Tag**         | `OZONE`<br/>`SECURITY`<br/>`MANAGEMENT` |
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`OM`<br/>`SCM`<br/>`CONTAINER`<br/>`STORAGE`<br/>`REQUIRED` |
...
|:----------------|:----------------------------|
| **Value**       | 128MB |
| **Tag**         | `OZONE`<br/>`OM`<br/>`SCM`<br/>`STORAGE`<br/>`PERFORMANCE` |
...
|:----------------|:----------------------------|
| **Value**       | true |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`OM`<br/>`DATANODE` |
...
| **Value**       | 0.0.0.0:9862 |
| **Tag**         | `OM`<br/>`REQUIRED` |
| **Description** | The address of the Ozone OM service. This allows clients to discover the address of the OM. When HA mode is enabled, append the service ID and node ID to each OM property. For example: `ozone.om.address`.service1.om1 |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.admin.protocol.max.retries` |
|:----------------|:----------------------------|
| **Value**       | 20 |
| **Tag**         | `OM`<br/>`MANAGEMENT` |
...
| **Name**        | `ozone.om.compaction.service.columnfamilies` |
|:----------------|:----------------------------|
| **Value**       | keyTable,fileTable,directoryTable,deletedTable,deletedDirectoryTable,multipartInfoTable |
| **Tag**         | `OZONE`<br/>`OM`<br/>`PERFORMANCE` |
| **Description** | A comma separated, no spaces list of all the column families that are compacted by the compaction service. If this is empty, no column families are compacted. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.compaction.service.enabled` |
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`OM`<br/>`PERFORMANCE` |
| **Description** | Enable or disable a background job that periodically compacts rocksdb tables flagged for compaction. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.compaction.service.run.interval` |
|:----------------|:----------------------------|
| **Value**       | 6h |
| **Tag**         | `OZONE`<br/>`OM`<br/>`PERFORMANCE` |
| **Description** | A background job that periodically compacts rocksdb tables flagged for compaction. Unit could be defined with postfix (ns,ms,s,m,h,d) |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.compaction.service.timeout` |
|:----------------|:----------------------------|
| **Value**       | 10m |
| **Tag**         | `OZONE`<br/>`OM`<br/>`PERFORMANCE` |
| **Description** | A timeout value of compaction service. If this is set greater than 0, the service will stop waiting for compaction completion after this time. Unit could be defined with postfix (ns,ms,s,m,h,d) |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`OM`<br/>`STORAGE`<br/>`PERFORMANCE` |
...
| **Name**        | `ozone.om.edekcacheloader.initial.delay.ms` |
|:----------------|:----------------------------|
| **Value**       | 3000 |
| **Tag**         |  |
| **Description** | When KeyProvider is configured, the time delayed until the first attempt to warm up edek cache on OM start up. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.edekcacheloader.interval.ms` |
|:----------------|:----------------------------|
| **Value**       | 1000 |
| **Tag**         |  |
| **Description** | When KeyProvider is configured, the interval time of warming up edek cache on OM starts up. All edeks will be loaded from KMS into provider cache. The edek cache loader will try to warm up the cache until succeed or OM leaves active state. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.edekcacheloader.max-retries` |
|:----------------|:----------------------------|
| **Value**       | 10 |
| **Tag**         |  |
| **Description** | When KeyProvider is configured, the max retries allowed to attempt warm up edek cache if none of key successful on OM start up. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.om.hierarchical.resource.locks.hard.limit` |
|:----------------|:----------------------------|
| **Value**       | 10000 |
| **Tag**         |  |
| **Description** | Maximum number of lock objects that could be present in the pool. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.hierarchical.resource.locks.soft.limit` |
|:----------------|:----------------------------|
| **Value**       | 1024 |
| **Tag**         |  |
| **Description** | Soft limit for number of lock objects that could be idle in the pool. |
--------------------------------------------------------------------------------
...
| **Value**       | 0.0.0.0 |
| **Tag**         | `OM`<br/>`MANAGEMENT` |
| **Description** | The actual address the OM web server will bind to. If this optional the address is set, it overrides only the hostname portion of `ozone.om.http-address`. When HA mode is enabled, append the service ID and node ID to each OM property. For example: `ozone.om.http-bind-host`.service1.om1 |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 0.0.0.0:9875 |
| **Tag**         | `OM`<br/>`MANAGEMENT`<br/>`SECURITY` |
| **Description** | The address and the base port where the OM web UI will listen on using HTTPS. If the port is 0 then the server will start on a free port. When HA mode is enabled, append the service ID and node ID to each OM property. For example: `ozone.om.https-address`.service1.om1 |
--------------------------------------------------------------------------------
...
| **Value**       | 0.0.0.0 |
| **Tag**         | `OM`<br/>`MANAGEMENT`<br/>`SECURITY` |
| **Description** | The actual address the OM web server will bind to using HTTPS. If this optional address is set, it overrides only the hostname portion of `ozone.om.https-address`. When HA mode is enabled, append the service ID and node ID to each OM property. For example: `ozone.om.https-bind-host`.service1.om1 |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 5s |
| **Tag**         | `OZONE`<br/>`OM`<br/>`RATIS`<br/>`MANAGEMENT`<br/>`DEPRECATED` |
...
| **Name**        | `ozone.om.lease.hard.limit` |
|:----------------|:----------------------------|
| **Value**       | 7d |
| **Tag**         | `OZONE`<br/>`OM`<br/>`PERFORMANCE` |
| **Description** | Controls how long an open hsync key is considered as active. Specifically, if a hsync key has been open longer than the value of this config entry, that open hsync key is considered as expired (e.g. due to client crash). Unit could be defined with postfix (ns,ms,s,m,h,d) |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.lease.soft.limit` |
|:----------------|:----------------------------|
| **Value**       | 60s |
| **Tag**         | `OZONE`<br/>`OM` |
| **Description** | Hsync soft limit lease period. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 32MB |
| **Tag**         | `OZONE`<br/>`DEBUG`<br/>`OM`<br/>`RATIS` |
...
|:----------------|:----------------------------|
| **Value**       | 5s |
| **Tag**         | `OZONE`<br/>`OM`<br/>`RATIS`<br/>`MANAGEMENT` |
...
|:----------------|:----------------------------|
| **Value**       | 4MB |
| **Tag**         | `OZONE`<br/>`OM`<br/>`RATIS`<br/>`PERFORMANCE` |
...
| **Value**       | 64MB |
| **Tag**         | `OZONE`<br/>`OM`<br/>`RATIS`<br/>`PERFORMANCE` |
| **Description** | The size of the raft segment used by Apache Ratis on OM. (64 MB by default) |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.om.ratis.server.pending.write.element-limit` |
|:----------------|:----------------------------|
| **Value**       | 4096 |
| **Tag**         | `OZONE`<br/>`DEBUG`<br/>`OM`<br/>`RATIS` |
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`OM`<br/>`STORAGE`<br/>`MANAGEMENT`<br/>`RATIS` |
...
| **Name**        | `ozone.om.read.threadpool` |
|:----------------|:----------------------------|
| **Value**       | 10 |
| **Tag**         | `OM`<br/>`PERFORMANCE` |
| **Description** | The number of threads in RPC server reading from the socket for OM service endpoints. This config overrides Hadoop configuration "ipc.server.read.threadpool.size" for Ozone Manager. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.s3.grpc.server_enabled` |
|:----------------|:----------------------------|
| **Value**       | true |
| **Tag**         | `OZONE`<br/>`OM`<br/>`S3GATEWAY` |
| **Description** | Property to enable or disable Ozone Manager gRPC endpoint for clients. Right now, it is used by S3 Gateway only. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.om.snapshot.compact.non.snapshot.diff.tables` |
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`OM`<br/>`PERFORMANCE` |
| **Description** | Enable or disable compaction of tables that are not tracked by snapshot diff when their snapshots are evicted from cache. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.om.snapshot.local.data.manager.service.interval` |
|:----------------|:----------------------------|
| **Value**       | 5m |
| **Tag**         |  |
| **Description** | Interval for cleaning up orphan snapshot local data versions corresponding to snapshots |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.snapshot.provider.connection.timeout` |
|:----------------|:----------------------------|
| **Value**       | 5000s |
| **Tag**         | `OZONE`<br/>`OM`<br/>`HA`<br/>`MANAGEMENT` |
...
| **Name**        | `ozone.om.snapshot.prune.compaction.backup.batch.size` |
|:----------------|:----------------------------|
| **Value**       | 2000 |
| **Tag**         | `OZONE`<br/>`OM` |
| **Description** | Prune SST files in Compaction backup directory in batches every `ozone.om.snapshot.compaction.dag.prune.daemon.run.interval`. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.om.snapshot.rocksdb.metrics.enabled` |
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`OM` |
| **Description** | Skip collecting RocksDBStore metrics for Snapshotted DB. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.recon.address` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `RECON`<br/>`MANAGEMENT` |
| **Description** | RPC address of Recon Server. If not set, datanodes will not configure Recon Server. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.recon.administrators` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `RECON`<br/>`SECURITY` |
...
|:----------------|:----------------------------|
| **Value**       | 150000 |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`PERFORMANCE` |
...
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`STORAGE`<br/>`PERFORMANCE` |
...
| **Name**        | `ozone.recon.dn.metrics.collection.minimum.api.delay` |
|:----------------|:----------------------------|
| **Value**       | 30s |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`DN` |
| **Description** | Minimum delay in API to start a new task for Jmx collection. It behaves like a rate limiter to avoid unnecessary task creation. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.recon.dn.metrics.collection.timeout` |
|:----------------|:----------------------------|
| **Value**       | 10m |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`DN` |
| **Description** | Maximum time taken for the api to complete. If it exceeds pending tasks will be cancelled. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.recon.filesizecount.flush.db.max.threshold` |
|:----------------|:----------------------------|
| **Value**       | 200000 |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`PERFORMANCE` |
| **Description** | Maximum threshold number of entries to hold in memory for File Size Count task in hashmap before flushing to recon derby DB |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | /etc/security/keytabs/HTTP.keytab |
| **Tag**         | `RECON`<br/>`SECURITY`<br/>`KERBEROS` |
...
|:----------------|:----------------------------|
| **Value**       | 0.0.0.0:9889 |
| **Tag**         | `RECON`<br/>`MANAGEMENT`<br/>`SECURITY` |
...
| **Name**        | `ozone.recon.om.event.buffer.capacity` |
|:----------------|:----------------------------|
| **Value**       | 20000 |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`OM`<br/>`PERFORMANCE` |
| **Description** | Maximum capacity of the event buffer used by Recon to queue OM delta updates during task reinitialization. When tasks are being reprocessed on staging DB, this buffer holds incoming delta updates to prevent blocking the OM sync process. If the buffer overflows, task reinitialization will be triggered. |
--------------------------------------------------------------------------------
...
| **Value**       | 5s |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`OM` |
| **Description** | Interval in SECONDS by Recon to request OM DB Snapshot. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.recon.task.reprocess.max.iterators` |
|:----------------|:----------------------------|
| **Value**       | 5 |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`PERFORMANCE` |
| **Description** | Maximum number of iterator threads to use for parallel table iteration during reprocess |
--------------------------------------------------------------------------------

| **Name**        | `ozone.recon.task.reprocess.max.keys.in.memory` |
|:----------------|:----------------------------|
| **Value**       | 2000 |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`PERFORMANCE` |
| **Description** | Maximum number of keys to batch in memory before handing to worker threads during parallel reprocess |
--------------------------------------------------------------------------------

| **Name**        | `ozone.recon.task.reprocess.max.workers` |
|:----------------|:----------------------------|
| **Value**       | 20 |
| **Tag**         | `OZONE`<br/>`RECON`<br/>`PERFORMANCE` |
| **Description** | Maximum number of worker threads to use for parallel table processing during reprocess |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | 4MB |
| **Tag**         | `OZONE`<br/>`S3GATEWAY` |
| **Description** | The size of the buffer which is for read block. (4MB by default). |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | /etc/security/keytabs/HTTP.keytab |
| **Tag**         | `OZONE`<br/>`S3GATEWAY`<br/>`SECURITY`<br/>`KERBEROS` |
...
|:----------------|:----------------------------|
| **Value**       | simple |
| **Tag**         | `S3GATEWAY`<br/>`SECURITY`<br/>`KERBEROS` |
| **Description** | simple or kerberos. If kerberos is set, SPNEGO will be used for http authentication. |
--------------------------------------------------------------------------------
...
| **Value**       | 0.0.0.0:9879 |
| **Tag**         | `OZONE`<br/>`S3GATEWAY` |
| **Description** | Ozone S3Gateway HTTPS server address and port. |
--------------------------------------------------------------------------------
...
| **Tag**         | `OZONE`<br/>`SECURITY`<br/>`KERBEROS`<br/>`S3GATEWAY` |
...
| **Name**        | `ozone.s3g.list.max.keys.limit` |
|:----------------|:----------------------------|
| **Value**       | 1000 |
| **Tag**         |  |
| **Description** | Maximum number of keys returned by S3 ListObjects/ListObjectsV2 API. AWS default is 1000. Can be overridden per deployment in ozone-site.xml. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.s3g.metrics.percentiles.intervals.seconds` |
|:----------------|:----------------------------|
| **Value**       | 60 |
| **Tag**         | `S3GATEWAY`<br/>`PERFORMANCE` |
...
| **Name**        | `ozone.s3g.webadmin.http-address` |
|:----------------|:----------------------------|
| **Value**       | 0.0.0.0:19878 |
| **Tag**         | `OZONE`<br/>`S3GATEWAY` |
| **Description** | The address and port where Ozone S3Gateway serves web content. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.s3g.webadmin.http-bind-host` |
|:----------------|:----------------------------|
| **Value**       | 0.0.0.0 |
| **Tag**         | `OZONE`<br/>`S3GATEWAY` |
| **Description** | The actual address the HTTP server will bind to. If this optional address is set, it overrides only the hostname portion of `ozone.s3g.webadmin.http-address`. This is useful for making the Ozone S3Gateway HTTP server listen on all interfaces by setting it to 0.0.0.0. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.s3g.webadmin.http.enabled` |
|:----------------|:----------------------------|
| **Value**       | true |
| **Tag**         | `OZONE`<br/>`S3GATEWAY` |
| **Description** | This option can be used to disable the web server which serves additional content in Ozone S3 Gateway. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.s3g.webadmin.https-address` |
|:----------------|:----------------------------|
| **Value**       | 0.0.0.0:19879 |
| **Tag**         | `OZONE`<br/>`S3GATEWAY` |
| **Description** | Ozone S3Gateway content server's HTTPS address and port. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.s3g.webadmin.https-bind-host` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`S3GATEWAY` |
| **Description** | The actual address the HTTPS server will bind to. If this optional address is set, it overrides only the hostname portion of `ozone.s3g.webadmin.https-address`. This is useful for making the Ozone S3Gateway HTTPS server listen on all interfaces by setting it to 0.0.0.0. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.scm.block.deletion.per.dn.distribution.factor` |
|:----------------|:----------------------------|
| **Value**       | 8 |
| **Tag**         | `OZONE`<br/>`SCM` |
| **Description** | Factor with which number of delete blocks sent to each datanode in every interval. If total number of DNs are 100 and hdds.scm.block.deletion.per-interval.max is 500000 Then maximum 500000/(100/8) = 40000 blocks will be sent to each DN in every interval. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.scm.block.handler.count.key` |
|:----------------|:----------------------------|
| **Value**       | 100 |
| **Tag**         | `OZONE`<br/>`MANAGEMENT`<br/>`PERFORMANCE` |
| **Description** | Used to set the number of RPC handlers when accessing blocks. The default value is 100. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.scm.block.read.threadpool` |
|:----------------|:----------------------------|
| **Value**       | 10 |
| **Tag**         | `OZONE`<br/>`MANAGEMENT`<br/>`PERFORMANCE` |
| **Description** | The number of threads in RPC server reading from the socket when accessing blocks. This config overrides Hadoop configuration "ipc.server.read.threadpool.size" for SCMBlockProtocolServer. The default value is 10. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.scm.client.read.threadpool` |
|:----------------|:----------------------------|
| **Value**       | 10 |
| **Tag**         | `OZONE`<br/>`MANAGEMENT`<br/>`PERFORMANCE` |
| **Description** | The number of threads in RPC server reading from the socket used by Client to access SCM. This config overrides Hadoop configuration "ipc.server.read.threadpool.size" for SCMClientProtocolServer. The default value is 10. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.scm.close.container.wait.duration` |
|:----------------|:----------------------------|
| **Value**       | 150s |
| **Tag**         | `SCM`<br/>`OZONE`<br/>`RECON` |
...
| **Name**        | `ozone.scm.container.list.max.count` |
|:----------------|:----------------------------|
| **Value**       | 4096 |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`CONTAINER` |
| **Description** | The max number of containers info could be included in response of ListContainer request. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.scm.container.lock.stripes` |
|:----------------|:----------------------------|
| **Value**       | 512 |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`PERFORMANCE`<br/>`MANAGEMENT` |
...
| **Tag**         | `OZONE`<br/>`MANAGEMENT` |
| **Description** | The full name of class which implements org.apache.hadoop.hdds.scm.PlacementPolicy. The class decides which datanode will be used to host the container replica. If not set, org.apache.hadoop.hdds.scm.container.placement.algorithms.SCMContainerPlacementRackAware will be used as default value. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.scm.container.size` |
|:----------------|:----------------------------|
| **Value**       | 5GB |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`MANAGEMENT` |
...
| **Name**        | `ozone.scm.datanode.read.threadpool` |
|:----------------|:----------------------------|
| **Value**       | 10 |
| **Tag**         | `OZONE`<br/>`MANAGEMENT`<br/>`PERFORMANCE` |
| **Description** | The number of threads in RPC server reading from the socket used by DataNode to access SCM. This config overrides Hadoop configuration "ipc.server.read.threadpool.size" for SCMDatanodeProtocolServer. The default value is 10. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.scm.db.dirs` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`STORAGE`<br/>`PERFORMANCE` |
...
|:----------------|:----------------------------|
| **Value**       | 9895 |
| **Tag**         | `OZONE`<br/>`SCM`<br/>`HA`<br/>`RATIS` |
...
|:----------------|:----------------------------|
| **Value**       | 30m |
| **Tag**         | `SCM`<br/>`OZONE`<br/>`HA`<br/>`RATIS` |
| **Description** | Deadline for SCM DB checkpoint interval. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.scm.ha.raft.server.rpc.first-election.timeout` |
|:----------------|:----------------------------|
| **Value**       |  |
| **Tag**         | `SCM`<br/>`OZONE`<br/>`HA`<br/>`RATIS` |
| **Description** | ratis timeout for the first election of a leader. If not configured, fallback to `ozone.scm.ha.ratis.leader.election.timeout`. |
--------------------------------------------------------------------------------
...
| **Value**       | 64MB |
| **Tag**         | `SCM`<br/>`OZONE`<br/>`HA`<br/>`RATIS` |
| **Description** | The size of the raft segment used by Apache Ratis on SCM. (64 MB by default) |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.scm.security.read.threadpool` |
|:----------------|:----------------------------|
| **Value**       | 1 |
| **Tag**         | `OZONE`<br/>`HDDS`<br/>`SECURITY`<br/>`PERFORMANCE` |
| **Description** | The number of threads in RPC server reading from the socket when performing security related operations with SCM. This config overrides Hadoop configuration "ipc.server.read.threadpool.size" for SCMSecurityProtocolServer. The default value is 1. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | unrestricted |
| **Tag**         | `OZONE`<br/>`SECURITY`<br/>`HDDS`<br/>`CRYPTO_COMPLIANCE` |
...
| **Value**       | RATIS |
| **Tag**         | `OZONE` |
| **Description** | Default replication type to be used while writing key into ozone. The value can be specified when writing the key, default is used when nothing is specified when creating key or no default value set at bucket. Supported values: RATIS, EC. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.snapshot.deep.cleaning.enabled` |
|:----------------|:----------------------------|
| **Value**       | false |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`OM` |
| **Description** | Flag to enable/disable snapshot deep cleaning. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.snapshot.defrag.limit.per.task` |
|:----------------|:----------------------------|
| **Value**       | 1 |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`OM` |
| **Description** | The maximum number of snapshots that would be defragmented in each task run of snapshot defragmentation service. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.snapshot.defrag.service.interval` |
|:----------------|:----------------------------|
| **Value**       | -1 |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`OM` |
...
| **Name**        | `ozone.snapshot.defrag.service.timeout` |
|:----------------|:----------------------------|
| **Value**       | 300s |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`OM` |
...
|:----------------|:----------------------------|
| **Value**       | 24h |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`OM`<br/>`DEPRECATED` |
| **Description** | DEPRECATED. The time interval between successive SnapshotDirectoryCleaningService thread run. |
--------------------------------------------------------------------------------
...
| **Value**       | 300s |
| **Tag**         | `OZONE`<br/>`PERFORMANCE`<br/>`OM`<br/>`DEPRECATED` |
| **Description** | DEPRECATED. Timeout value for SnapshotDirectoryCleaningService. |
--------------------------------------------------------------------------------
...
| **Name**        | `ozone.volume.io.percentiles.intervals.seconds` |
|:----------------|:----------------------------|
| **Value**       | 60 |
| **Tag**         | `OZONE`<br/>`DATANODE` |
| **Description** | This setting specifies the interval (in seconds) for monitoring percentile performance metrics. It helps in tracking the read and write performance of DataNodes in real-time, allowing for better identification and analysis of performance issues. |
--------------------------------------------------------------------------------

| **Name**        | `ozone.xceiver.client.metrics.percentiles.intervals.seconds` |
|:----------------|:----------------------------|
| **Value**       | 60 |
| **Tag**         | `XCEIVER`<br/>`PERFORMANCE` |
...
| **Name**        | `recon.om.delta.update.lag.threshold` |
|:----------------|:----------------------------|
| **Value**       | 0 |
| **Tag**         | `OZONE`<br/>`RECON` |
| **Description** | At every Recon OM sync, recon starts fetching OM DB updates, and it continues to fetch from OM till the lag, between OM DB WAL sequence number and Recon OM DB snapshot WAL sequence number, is less than this lag threshold value. |
--------------------------------------------------------------------------------
...
|:----------------|:----------------------------|
| **Value**       | jks |
| **Tag**         | `OZONE`<br/>`SECURITY`<br/>`CRYPTO_COMPLIANCE` |
