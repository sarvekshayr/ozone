...
<!---
  This file is AUTO-GENERATED from ozone-default-generated.xml.
  Do not edit it manually. Run the following command to regenerate:
  
  python3 dev-support/ci/xml_to_md.py <path-to-ozone-dist> hadoop-hdds/docs/content/tools/Configurations.md
-->
